 ...
 * Copyright (c) 2009-2012 by Chill, Inc. All Rights Reserved.
...
//@interface ChillObject : NSObject
//@end

@interface ChillObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ChillObject class]])
		{
			for (NSString *key in [[(ChillObject*)o modules] allKeys])
			{
