...
// in simulator we redefine to format for Chill Developer console
...
{\
	NSString * exceptionName = [@"org.chill." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.chill";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIChillNativeItemNone = -1, 
	UIChillNativeItemSpinner = -2,
	UIChillNativeItemProgressBar = -3,
	
	UIChillNativeItemSlider = -4,
	UIChillNativeItemSwitch = -5,
	UIChillNativeItemMultiButton = -6,
	UIChillNativeItemSegmented = -7,
	
	UIChillNativeItemTextView = -8,
	UIChillNativeItemTextField = -9,
	UIChillNativeItemSearchBar = -10,
	
	UIChillNativeItemPicker = -11,
	UIChillNativeItemDatePicker = -12,
	
	UIChillNativeItemInfoLight = -13,
	UIChillNativeItemInfoDark = -14,
	
	UIChillNativeItemDisclosure = -15,
	
	UIChillNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Chill instances of
